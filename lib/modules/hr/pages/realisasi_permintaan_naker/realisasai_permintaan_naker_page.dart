...
class RealisasiPermintaanNakerPage extends StatefulWidget {
  const RealisasiPermintaanNakerPage({super.key});

  @override
  State<RealisasiPermintaanNakerPage> createState() =>
      _RealisasiPermintaanNakerPageState();
}

class _RealisasiPermintaanNakerPageState
    extends State<RealisasiPermintaanNakerPage>
  ...
  Future<void> getNomorPTK() async {
    var listNomorPtk = await api.getNomorPtk(false);
    setState(() {
          ...
          IconButton(
            onPressed: () {
              ...
              var data = ApiParams(
                ...
                nik: nik,
                barang: barang,
                method: HrMethodApi.formRealisasiNaker,
