...
import 'package:uapp/modules/hr/pages/permintaan_naker/history_page.dart';
  ...
  void _ajukanPermintaan() async {
    if (_formKey.currentState!.validate()) {
      final params = ApiParams(
        method: isEditing
            ? HrMethodApi.editPermintaanTenagaKerja
            : HrMethodApi.formPermintaanTenagaKerja,
      ...
      String? result = await apiNaker.addPermintaanNaker(params);
      if (Get.isDialogOpen!) {
        Get.back();
      }
      if (result != null) {
