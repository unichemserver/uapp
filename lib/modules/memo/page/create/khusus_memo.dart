...
class KhususMemo extends StatefulWidget {
  const KhususMemo({super.key});

  @override
  State<KhususMemo> createState() => _KhususMemoState();
}

class _KhususMemoState extends State<KhususMemo> {
  ...
  void _saveMemo(BuildContext context) async {
    ...
    api.saveMemo<MemoKhusus>(data, url).then((response) {
      Navigator.pop(context);
      if (response == null) {
        _formKey.currentState?.reset();
        Navigator.pop(context);
        String message = 'Memo berhasil disimpan';
        if (isEditing) {
          message = 'Perubahan memo berhasil disimpan';
  ...
  void isEditMemo(MemoKhusus? memo) {
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(
                    isEditing ? 'Simpan Perubahan' : 'Kirim Memo',
                  ),
                ),
                const SizedBox(height: 16),
              ],
