...
class KoordinasiMemo extends StatefulWidget {
  const KoordinasiMemo({super.key});

  @override
  State<KoordinasiMemo> createState() => _KoordinasiMemoState();
}

class _KoordinasiMemoState extends State<KoordinasiMemo> {
  ...
  void _saveMemo(BuildContext context) async {
    MemoKoordinasi data = MemoKoordinasi(
    ...
    api.saveMemo<MemoKoordinasi>(data, url).then((response) {
      Navigator.pop(context);
      if (response == null) {
  ...
  void isEditMemo(MemoKoordinasi? memo) {
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text(
                    isEditing ? 'Simpan Perubahan' : 'Simpan Memo',
                  ),
                ),
                const SizedBox(height: 16),
              ],
