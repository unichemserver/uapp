  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          _buildReadOnlyTextField('ID Cust', masternoo['id']),
          const SizedBox(height: 16),
          _buildReadOnlyTextField('ID Noo', masternoo['id_noo']),
          const SizedBox(height: 16),
          ...
          const SizedBox(height: 16),
          _buildReadOnlyTextField('Metode Pembayaran', masternoo['payment_method']),
          const SizedBox(height: 16),
